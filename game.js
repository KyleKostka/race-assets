...
var HELMBODY=-1;function helmBody(fi,hide){var cm=b[fi]&&b[fi].mesh;if(!cm)return;var ws=cm.userData.wheels||[];cm.traverse(function(q){if(q.isMesh)q.visible=hide?ws.indexOf(q)>=0:!0})}
...
let nearW=seat?.12:.5;if(G.near!==nearW){G.near=nearW;G.updateProjectionMatrix()}var wantHB=md==="HELMET"?C.focus:-1;if(HELMBODY!==wantHB){if(HELMBODY>=0)helmBody(HELMBODY,!1);if(wantHB>=0)helmBody(wantHB,!0);HELMBODY=wantHB}
if(md==="FREE"){
...
else if(md==="HELMET"){let hm=A0.mesh&&A0.mesh.userData.helmet;g.y+=hm?hm.h:1;g.addScaledVector(q3,hm?hm.fwd:.9);a.copy(g);d.copy(g).addScaledVector(q3,20);d.addScaledVector(rt,(A0.lat||0)*.6);d.y+=.06}
...
imola:{n:"IMOLA",l:"4.909 km"},silverstone:{n:"SILVERSTONE",l:"5.891 km"},barcelona:{n:"BARCELONA",l:"4.675 km"},singapore:{n:"SINGAPORE",l:"5.063 km"},shanghai:{n:"SHANGHAI",l:"5.451 km"}};
var TOK={};
